...
<div class="space-y-4">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
        <div class="flex flex-wrap items-center justify-between gap-3 px-5 py-4 border-b border-gray-100">
            <div class="flex flex-wrap gap-2" id="testimonials-export-buttons"></div>
...
<style>
    #testimonials-export-buttons .dt-button {
    ...
    #testimonials-export-buttons .dt-button:hover { background: #eff6ff !important; color: #1d4ed8 !important; border-color: #bfdbfe !important; }
