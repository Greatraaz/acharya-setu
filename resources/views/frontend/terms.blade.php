...
@section('title', 'Terms & Conditions — Vedrix')
...
<div class="container-sm">
    ...
    @php
    $sections = [
        ['Acceptance','By registering on or using Vedrix, you agree to these Terms. If you disagree with any part, please do not use our platform.'],
        ['Eligibility','You must be at least 16 years old to use Vedrix as a mentee, and at least 21 years old to register as a mentor. By using the platform, you represent that you meet these requirements.'],
        ...
        ['Payments & Wallet','Sessions are billed at the mentor\'s stated per-minute rate, deducted from your Vedrix wallet. Wallet top-ups are processed via Razorpay. Unused wallet balance may be refunded within 7 business days of a written request. Session payments are final once a session is completed.'],
        ...
        ['Intellectual Property','All content on Vedrix — platform design, curriculum material, blog posts — is owned by Vedrix or its licensors. Session recordings (if enabled) are private and may not be shared without written consent from both parties.'],
        ...
        ['Limitation of Liability','Vedrix is a marketplace connecting mentors and mentees. We are not responsible for the accuracy of mentor-provided advice or career outcomes. Mentors are independent contractors, not employees. Our liability is limited to the amount paid for the disputed session.'],
