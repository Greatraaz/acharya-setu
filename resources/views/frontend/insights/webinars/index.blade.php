@php
    ...
    $pageTitle = $type === \App\Models\InsightEvent::TYPE_WEBINAR ? 'Webinars & Live Events' : 'Events';
    $eyebrow = $type === \App\Models\InsightEvent::TYPE_WEBINAR ? '🎥 Knowledge Sessions' : '📅 Live Events';
        ...
        <div class="container">
            ...
            @if($sessions->isEmpty())
                <div class="blog-empty">
                    <div class="blog-empty__icon">{{ $type === \App\Models\InsightEvent::TYPE_WEBINAR ? '🎥' : '📅' }}</div>
