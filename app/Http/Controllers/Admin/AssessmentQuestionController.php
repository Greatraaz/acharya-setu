...

{
...

    {
        ...
        return view('admin.assessments.questions.index', compact('questions', 'assessments'));
...

    {
        ...
        return view('admin.assessments.questions.create', compact('assessments', 'question'));
...

    {
        ...
        return view('admin.assessments.questions.edit', compact('assessments', 'question'));
